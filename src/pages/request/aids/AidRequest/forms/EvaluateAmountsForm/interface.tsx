...
function EvaluateAmountsFormUI(props: EvaluateAmountsFormUIProps) {
    ...
    const calculateRemainingQuota = (): string => {
        ...
        const cost = formik.values[forAmount ? "costAid" : "daysAid"] || 0;
    ...
    const isSimulateButtonDisabled: boolean = forAmount ? (!!formik.errors.costAid || formik.values.costAid === 0) : !beneficiary;
                    ...
                    forAmount && (
                        <Stack direction="column" gap={inube.spacing.s250}>
                            <Moneyfield
                                ...
                                value={validateCurrencyField("costAid", formik, false)}
                                type="text"
                                message={forAmount ? formik.errors.costAid : formik.errors.daysAid}
                                size="compact"
                                fullwidth
                                status={getFieldState(formik, forAmount ? "costAid" : "daysAid")}
