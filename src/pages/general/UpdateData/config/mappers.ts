...
const mapContactData = (contactInfoData: IContactData): IContactDataEntry => {
  return {
    ...
    zipCode: contactInfoData.zipCode || 0,
    landlinePhone: contactInfoData.landlinePhone || 0,
...
const mapFamilyGroup = (
  ...
  return {
    ...
    zipCode: familyGroupData.contact.zipCode  || 0,
    landlinePhone: familyGroupData.contact.landlinePhone || 0,
